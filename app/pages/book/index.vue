<template>
  <div class="relative z-10 w-full max-w-[560px] px-4">
    <UCard
      class="w-full rounded-lg p-2 shadow-lg my-5"
      :ui="{
...
const canReturn = computed(() => {
  return selectedBorrowedBook.value && returnPhotoAttachmentId.value && returnForm.goodreadsLink.trim() && !isSubmitting.value
})
