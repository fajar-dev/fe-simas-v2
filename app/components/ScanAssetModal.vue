<template>
  ...
  >
    <template #body>
        ...
        <div class="w-full aspect-square bg-neutral-950 rounded-lg overflow-hidden relative flex items-center justify-center">
          ...
          <template v-if="scanMode === 'conventional'">
            ...
            <component
              ...
              v-if="!barcode.error.value && open && !isSearching && activeTab === 'barcode' && scanMode === 'conventional'"
      ...
      <!-- Manual Input -->
      <div class="mt-4">
        <label class="text-xs font-medium text-muted uppercase tracking-wider block mb-1.5">{{ $t('component.scanAsset.manualEntry') }}</label>
