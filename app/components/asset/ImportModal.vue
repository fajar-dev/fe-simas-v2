      ...
      <UCard>
        ...
        <div class="flex items-center justify-between mb-4">
          <div class="flex items-center gap-3">
            ...
            <div>
              <h3 class="text-base font-semibold text-neutral-900">Import Assets</h3>
              <p class="text-xs text-neutral-500">Upload Excel file to import assets</p>
            </div>
          </div>
          <UButton
            color="neutral"
        ...
        <!-- Download Template -->
        <div class="bg-neutral-50 border border-neutral-200 rounded-lg p-3 mb-4">
